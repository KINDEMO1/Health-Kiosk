    ...
    <div className="h-screen w-screen flex items-center justify-center bg-gray-100 overflow-hidden">
      <div className="w-full h-[600px] max-w-5xl flex shadow-lg rounded-2xl overflow-hidden">
        ...
        >
          ...
          <p className="mt-2 text-lg text-center">Join us and explore endless possibilities.</p>
        </motion.div>
...
>
                  ...
                  <div className="flex items-center">
                    <input type="checkbox" className="mr-2" id="rememberMeSignUp" />
                    <label htmlFor="rememberMeSignUp" className="text-sm text-gray-700">Remember Me</label>
                  </div>
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
