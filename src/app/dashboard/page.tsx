...
import { FaUser, FaUserMd, FaPrint, FaSignOutAlt, FaHeartbeat } from "react-icons/fa"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-white flex flex-col items-center p-4">
      ...
      <div className="w-[700px] max-w-full px-4 sm:px-8">
        ...
        {/* Title */}
        <h1 className="text-3xl font-extrabold text-center text-gray-900 mt-2">{t("dashboard.homepage")}</h1>
